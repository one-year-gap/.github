...
<a id="overview"></a>
## 📌 프로젝트 소개 (Overview)
Holliverse는 **통신사의 고객 데이터를 기반**으로 고객의 특성을 이해하고 분류하는 과정을 서비스로 구현하는 **통합 프로젝트**입니다.  
...
- 하단의 배너를 통해 두가지 페이지로 이동이 가능합니다.
  1. 고객 유형 캐릭터 페이지
     - Holliverse에서는 사용자에게 사용패턴에 맞는 캐릭터를 지정해줍니다.
...
- Holliverse는 사용자의 서비스 이용 정보를 분석하여 고객 유형 캐릭터를 지정해줍니다.
...
Holliverse는 **업무 성격이 다른 두 영역**을 함께 다룹니다.
